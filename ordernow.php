...
<body>
    ...
    <h6 class="cusno"> Hi, <?php echo $_POST["name"]; ?> <br>
        What Do You would Like to have?</h6>  <img class="logo" src="onlylogo.png" width="60px" height="50px"> </div>
         ...
         echo'<div class="hrr"></div> <div class="theitem">
            ...
            <div class="itemvector '. $row["itemid"].'">' . $row["itemname"]. '</div>
                  ...
                  <div class="rightside">
                      ...
                      <button class="clickbfnadd '. $row["itemid"].' add" onclick="additem(this,\'cartshow\')" >
                      ...
                      <div class="addminusbtncontainer"><button class="minusbtn '. $row["itemid"].'" onclick="additem(this,\'minus\')">-</button><div class="no '. $row["itemid"].'">0</div><button  onclick="additem(this,\'add\')" class="plusbtn '. $row["itemid"].'">+</button></div>
					...
					echo"<div class='runningfast'>No of {$row["itemname"]} left: <span class='itemsleft {$row["itemid"]}'>{$row["available"]}</span></div>";
...
<div class="totalcontainer"><div class="totaltext">            <i class="fa fa-shopping-cart" onclick="opencart()" style="font-size:20px;cursor:pointer"></i>
 ...
 var idlists = JSON.stringify(idlist1);     
    ...
    form.setAttribute("action", "ordernowconfirm.php");
...
function updatetable(obj,arg){
        ...
        for(i = 0; i < noofitem; i++){
            ...
            let nos = obj[i][5].nos; 
            let availablity =obj[i][6].available; 
			
			if(parseInt(availablity)>0){
			...
			document.getElementsByClassName("avilability "+itemid)[0].classList.remove("grayout");	
			}
			
			else{
				
			document.getElementsByClassName("avilability "+itemid)[0].classList.add("grayout");
...
<script>
    ...
    <script>
            ...
            document.getElementsByClassName("avilability "+opnlist[i].classList[1])[0].style.display = "";
            opnlist[i].style.display = "";
        } else {
			 test=test+1;
             document.getElementsByClassName("avilability "+opnlist[i].classList[1])[0].style.display = "none";
        }
